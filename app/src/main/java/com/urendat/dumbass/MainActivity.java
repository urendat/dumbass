      ...
      switch (pageNumber) {
        ...
        case 2:
          lies.append("WHITE HOUSE CHAOS: \n")
            ...
            .append("\n")
            .append("\n")
            .append("Rob Porter - resigned after spousal abuse details emerged\n")
            .append("Hope Hicks - resigned after lying to Mueller investigation\n")
            ...
            .append("\n")
            .append("\n")
            .append("Drain the swamp - Trump hired more than 187 former lobbyists into senior WH positions\n")
            .append("  EPA chief\n")
            .append("\n")
            .append("\n")
            .append("\n")
